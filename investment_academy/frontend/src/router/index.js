...
import KnowledgePhase from '../views/knowledge/KnowledgePhase.vue'
import PracticeLab from '../views/practice/PracticeLab.vue'
...
const routes = [
  ...
  { path: '/knowledge/p1_basics', name: 'P1Basics', component: KnowledgePhase, props: { phaseId: 'p1_basics' } },
  { path: '/knowledge/:phaseId', name: 'KnowledgePhase', component: KnowledgePhase, props: true },
  { path: '/practice/m1_data_lab', name: 'M1DataLab', component: PracticeLab, props: { labId: 'm1_data_lab' } },
  { path: '/practice/:labId', name: 'PracticeLab', component: PracticeLab, props: true },
